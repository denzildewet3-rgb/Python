...
class Alien_invasion:
    ...
    def _create_fleet(self):
        """Create the fleet class"""
        # Creating an alien and keep adding aliens until there is no room left.
    ...
    def _create_alien(self, x_position, y_position):
        """Create an alien and place it in position"""
    ...
    def _check_fleet_edges(self):
        """Respond appropriatly if any aliens have reached and edge"""
